          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: _filterByArea ? AppColors.primaryBlue : AppColors.lightGrey),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(
                    _filterByArea ? Icons.check_circle : Icons.radio_button_unchecked,
                    size: 14,
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    hasFilter
                        ? '${isMalay ? 'Filter' : 'Filter'} (${_selectedCategories.length})'
          ...
          if (bantuan.imageUrl != null)
            ClipRRect(
              ...
              child: Image.network(bantuan.imageUrl!,
                  ...
                  errorBuilder: (_, __, ___) => _buildImagePlaceholder(isMalay)),
            )
          else
            ClipRRect(
              borderRadius: const BorderRadius.vertical(top: Radius.circular(16)),
              ...
              children: [
                Row(children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: typeColor.withOpacity(0.1), borderRadius: BorderRadius.circular(20)),
