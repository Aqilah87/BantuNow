...
class _PostBantuanScreenState extends State<PostBantuanScreen> {
  ...
  Future<void> _pickImage(ImageSource source, bool isMalay) async {
    try {
      final picked = await _imagePicker.pickImage(source: source, maxWidth: 1080, maxHeight: 1080, imageQuality: 80);
      if (picked != null) setState(() => _selectedImage = File(picked.path));
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${isMalay ? 'Gagal pilih gambar' : 'Failed to pick image'}: $e')),
        );
      }
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (_selectedImage != null) ...[
              ...
              TextButton.icon(
                onPressed: () { setState(() => _selectedImage = null); Navigator.pop(ctx); },
                icon: const Icon(Icons.delete_outline, color: Colors.red),
                label: Text(isMalay ? 'Buang Gambar' : 'Remove Image', style: const TextStyle(color: Colors.red)),
              ),
            ],
  ...
  Future<void> _submit(bool isMalay) async {
    ...
    if (_selectedAreaId.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(isMalay ? 'Sila pilih kawasan' : 'Please select area')));
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(isMalay ? 'Post Bantuan' : 'Post Help',
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: _selectedImage != null ? AppColors.primaryBlue : AppColors.lightGrey,
                  ...
                  : _buildTextField(
                      ...
                      validator: (val) {
                        if (val == null || val.isEmpty)
                          return isMalay ? 'Sila masukkan nombor WhatsApp' : 'Please enter WhatsApp number';
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : Text(isMalay ? 'Post Bantuan' : 'Post Help',
