...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      final results = await Future.wait([docFuture, postsFuture, prefsFuture]);
  ...
  String get _roleLabel {
    if (_requestCount > 0 && _offerCount > 0) return 'Both';
    if (_offerCount > 0) return 'Helper';
    if (_requestCount > 0) return 'Requester';
    return 'New Member';
  }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context)
            .showSnackBar(SnackBar(content: Text('Gagal kemaskini: $e')));
      }
    }
  }
                    ...
                    child: Column(
                      children: [
                        ...
                        if (!_isEditing) ...[
                          ...
                          Text('Tekan gambar untuk tukar foto',
                              style: TextStyle(
                                  color: Colors.white70, fontSize: 13)),
                        ],
                      ],
                      ...
                      children: [
                        ...
                        _buildCard(children: [
                          ...
                          _buildInfoRow(
                            ...
                            label: 'Email',
                            value: user?.email ?? 'Tidak ditetapkan',
                          ),
                          const Divider(height: 1),
                          _buildInfoRow(
                        ...
                        _buildCard(children: [
                          _buildActionRow(
                            ...
                            label: 'Tetapan / Settings',
                            subtitle: 'Notifikasi, privasi, tentang app',
                            color: AppColors.primaryBlue,
